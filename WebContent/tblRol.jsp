<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="entidades.Rol, datos.Dt_Rol, java.util.*;" %>
<!DOCTYPE html>
<html>
<head>
                        ...
                        <div class="card-body">
                        	<div align="right">
                        		...
                        		<a href="tblRolOpc.jsp">
                        			<h7 class="fas fa-user-plus fa-2x" title="Agregar Opcion a Rol">Opción a Rol</h7>
                        		</a>
                        		<h7> |</h7>
                        		&nbsp;&nbsp;
                                ...
                                %>
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                           		<a id="btn-edita-abrir" href="editRol.jsp?RolID=<%=r.getRolID()%>">
