<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" import="entidades.VW_RolOpciones, entidades.RolOpciones, datos.Dt_RolOpciones, java.util.*;" %>
<!DOCTYPE html>
<html>
    ...
    <section id="about" class="about">
      ...
      <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Desde esta pantalla del sistema usted podrá controlar la creación, actualización y el dar de baja a opciones de roles.</p>
					
					
                    <!-- DataTables Usuarios -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Roles con Opciones asignadas</h6>
                        </div>
                        <div class="card-body">
                        	<div align="right">
