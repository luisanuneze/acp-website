		...
		<section id="about" class="about">
			...
			<div class="container-fluid">
				...
				<p class="mb-4">Desde esta pantalla del sistema usted podrá
					controlar la creación, actualización y el dar de baja a los
					Servicios.</p>
					...
					<div class="card-body">
						<div align="right">
							...
							<a href="NuevoServicio.jsp" data-toggle="modal"
								...
								class="fas fa-plus-square fa-2x" title="Registrar Nuevo Servicio"></i>
							</a>
							<!-- FIN Button trigger modal -->
							&nbsp;&nbsp; <a href="#"> <i class="fas fa-print fa-2x"
								title="Imprimir Lista de Servicios Activos"></i>
							</a> 
							<!-- <a href="tblRolUser.jsp">
								<button style="background-color: #0e203f; color: white">
									Rol a Usuario</button>
							</a>-->
							...
							<table class="table table-bordered" id="tblUsers" width="100%"
								...
								<tbody>
									<%
                                       	...
                                       	%>
									<tr>
										<td><%=ser.getServiciosid() %></td>
										<td><%=ser.getNombre() %></td>
										<td><%=ser.getFoto() %></td>
										<td><%=ser.getDescripcion() %></td>
										<td><%=ser.getEstado()==1||ser.getEstado()==2?"ACTIVO":"INACTIVO" %></td>
										<td><a id="btn-edita-abrir"
											href="EditarServicio.jsp?serviciosid=<%=ser.getServiciosid()%>">
												<i class="fas fa-edit" title="Modificar datos del Servicio"></i>
										</a> <a href="#"> <i class="fas fa-trash-alt"
												title="Eliminar Servicio"></i>
										</a> <a href="#"> <i class="fas fa-eye"
												title="Visualizar Servicio"></i>
										</a></td>
									</tr>
									<%
                                       		}
