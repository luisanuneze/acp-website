<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="entidades.Arbol, datos.Dt_Arbol, entidades.VW_Arbol, java.util.*;"%>
<!DOCTYPE html>
<html>
<head>
		                 ...
		                 listArbol = dta.listaArbol();
                          ...
                          <tbody>
                             ...
                             <tr>
                                 ...
                                 <td><%=ar.getGenero() %></td>
                                 <td><%=ar.getFamilia() %></td>
                                 <td><%=ar.getEpocaFloracion() %></td>
                                 <td><%=ar.getDistribucion() %></td>
                                 <td><a id="btn-edita-abrir" href="EditarArboles.jsp"> <i class="fas fa-edit" >Editar</i></a> 
