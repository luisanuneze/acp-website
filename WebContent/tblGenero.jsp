...
<script src="jAlert/dist/jAlert-functions.min.js"> //optional!!</script>
 	...
 	<script>
        ...
        if(mensaje == "1")
    {
       successAlert('Éxito', 'El Genero ha sido registrado exitosamente!');
    }
       if(mensaje == "2")
    {
       ...
       if(mensaje == "3")
    {
       successAlert('Éxito','El Genero ha sido actualizado exitosamente!');
    }
       if(mensaje == "4")
    {
       errorAlert('Error', 'Revise los datos e intente nuevamente!!!');
       ...
       if(mensaje == "5")
       {
           successAlert('Éxito', 'El Genero ha sido dado de baja exitosamente!');
       }
       if(mensaje == "6")
       {
           errorAlert('Error', 'Revise los datos e intente nuevamente!!!');
