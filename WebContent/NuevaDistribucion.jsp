<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="entidades.Distribucion, datos.Dt_Distribucion, entidades.Pais, datos.Dt_Pais, entidades.VW_PaisRegion, java.util.*;"%>
<!DOCTYPE html>
<html>
	            ...
	            <div class="row col-md-12">
                    <div class="col-sm-11">
                        ...
                        <option value="">País...</option>
                     	...
                     	%>
                         <option value="<%= pa.getID() %>"><%= pa.getPais() %></option>
                          <%
                     		}
                         %>
