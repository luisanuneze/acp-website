    ...
    <section id="about" class="about">
      ...
      <!-- Begin Page Content -->
                <div class="container-fluid container">
                    ...
                    <p class="mb-4">Desde esta pantalla del sistema usted podrá controlar la creación, actualización y el dar de baja a los eventos.</p>
                                ...
                                %>
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                           ...
                                           <td><%=eve.getTipoevento() %></td>
                                           <td><%=eve.getUbicacion() %></td>
                                           <td><%=eve.getFechainicio() %></td>
                                           <td><%=eve.getFechafin() %></td>
                                           <td><%=eve.getEstado()==1||eve.getEstado()==2?"ACTIVO":"INACTIVO" %></td>
                                           <td>
